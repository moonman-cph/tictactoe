...
const IGNORED_FIELDS = new Set(['orgId', '_simLabel', 'isNew', 'snapshots', 'plannedChange', 'dragMode', 'matrixMode', 'hideLevels']);
...
const COLLECTIONS = [
  ...
  { key: 'assignmentPolicies',       entityType: 'assignmentPolicy',        labelField: 'name' },
